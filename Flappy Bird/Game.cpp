...
struct Themes
{
    ...
    void ChoosingThemeGUI()
    {
        ...
        {
            if (Mouse::isButtonPressed(Mouse::Left) && Mouse::getPosition(window).x > 839 && Mouse::getPosition(window).x < 1265 && Mouse::getPosition(window).y > 40 && Mouse::getPosition(window).y < 670 && !press)
            {
                ChooseTheme = 3;
                press = true;
                if (th)
            ...
            if (Mouse::isButtonPressed(Mouse::Left) && Mouse::getPosition(window).x > 438 && Mouse::getPosition(window).x < 838 && Mouse::getPosition(window).y > 40 && Mouse::getPosition(window).y < 670 && !press)
            {
                ChooseTheme = 0;
                press = true;
                if (th)
            ...
            if (Mouse::isButtonPressed(Mouse::Left) && Mouse::getPosition(window).x > 438 && Mouse::getPosition(window).x < 838 && Mouse::getPosition(window).y > 363 && Mouse::getPosition(window).y < 723 && !press)
            {
                ChooseTheme = 1;
                press = true;
                if (th)
